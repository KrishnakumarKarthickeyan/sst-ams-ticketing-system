...
async function run() {
  ...
  console.log("Running massive tickets select query as Yousuf...");
  ...
  if (error) {
    console.error("❌ Query FAILED! Error code:", error.code, "Message:", error.message);
  } else {
    console.log("✅ Query SUCCEEDED! Fetched tickets count:", data.length);
  }
}
