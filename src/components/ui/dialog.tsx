...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-sm font-bold uppercase tracking-wider text-zinc-950",
      className
    )}
    {...props}
  />
