...
const SECURITY_ITEMS = [
  ...
  { icon: KeyRound, title: 'SSO', text: 'SAML and OIDC federation with your identity provider.' },
  { icon: Fingerprint, title: 'MFA', text: 'Step-up authentication for privileged operations.' },
