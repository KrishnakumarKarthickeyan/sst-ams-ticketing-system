  ...
  return (
    <div className="space-y-6 font-mono text-xs text-zinc-900">
      <div className="border-b border-zinc-200 pb-4">
        <h1 className="text-lg font-bold uppercase text-zinc-950 font-mono">Service Tickets Ledger</h1>
        <p className="text-zinc-500 mt-1">Review active and completed incidents, trace root causes, and monitor SLAs.</p>
      </div>
      ...
      {/* Grid */}
      {loading ? (
        <div className="py-20 text-center text-zinc-500 font-semibold">Loading tickets list...</div>
