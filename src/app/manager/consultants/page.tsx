  ...
  useEffect(() => {
    ...
    if (storedConsultants) {
      ...
      const defaultConsultants: ConsultantProfile[] = [
        { id: 'usr-consult-333', name: 'Priya Raman', role: 'Functional MM/SD Lead', email: 'consultant@sap.com', modules: ['MM', 'SD', 'FICO', 'HCM'], skills: 'MM Configuration, Pricing Procedures, Shipping Points, OB52, LSMW', phone: '+91 98765 00001', active: true, joiningDate: '2025-12-01', consultantType: 'Functional' },
        { id: 'usr-consult-444', name: 'Arjun Mehta', role: 'Technical BASIS Administrator', email: 'arjun.technical@example.com', modules: ['BASIS', 'ABAP', 'CPI', 'Fiori'], skills: 'Transport Management, RLS Policies, RFC Destinations, SSL Encryption, Kernel Updates', phone: '+91 98765 43210', active: true, joiningDate: '2025-10-15', consultantType: 'Technical' },
        { id: 'usr-consult-111', name: 'Karthik Subramanian', role: 'Senior Functional Consultant', email: 'karthik@sap.com', modules: ['MM', 'SD', 'PP'], skills: 'Subcontracting, Purchase Orders, Batch Management, MRP configurations', phone: '+91 98765 11111', active: true, joiningDate: '2024-07-01', consultantType: 'Functional' },
        { id: 'usr-consult-222', name: 'Elena Rostova', role: 'BASIS Security Expert', email: 'elena@sap.com', modules: ['BASIS', 'Security'], skills: 'GRC Access Control, Role Maintenance, Firefighter IDs, Audit Logs', phone: '+91 98765 22222', active: true, joiningDate: '2025-03-10', consultantType: 'Technical' },
        { id: 'usr-consult-555', name: 'Rajesh Kumar', role: 'Lead ABAP Developer', email: 'rajesh@sap.com', modules: ['ABAP', 'CPI'], skills: 'Smartforms, Adobe Forms, Enhancements, OData Services, CPI flows', phone: '+91 98765 33333', active: true, joiningDate: '2024-09-01', consultantType: 'Technical' }
      ];
    ...
    if (storedCustomers) {
      ...
      const defaultCustomers: CustomerProfile[] = [
        { id: 'cust-apex', company: 'Apex Global Industries', contact: 'Sarah Jenkins', email: 'customer@sap.com', phone: '+1 555-0199', contractType: 'Premium SLA', expectedHours: 160, active: true, csat: 4.8 },
        { id: 'cust-titan', company: 'Titan Energy Corp', contact: 'David Vance', email: 'david.vance@titan.com', phone: '+1 555-0211', contractType: 'Standard SLA', expectedHours: 120, active: true, csat: 4.2 },
        { id: 'cust-nexa', company: 'Nexa Manufacturing', contact: 'Marta Beck', email: 'marta.beck@nexa.com', phone: '+1 555-0322', contractType: 'Enterprise SLA', expectedHours: 200, active: true, csat: 4.5 },
        { id: 'cust-orion', company: 'Orion Logistics', contact: 'Tom Clark', email: 'tom.clark@orion.com', phone: '+1 555-0455', contractType: 'Standard SLA', expectedHours: 100, active: true, csat: 4.6 },
        { id: 'cust-stellar', company: 'Stellar Retail', contact: 'Olivia Stone', email: 'olivia.stone@stellar.com', phone: '+1 555-0588', contractType: 'Basic Support', expectedHours: 80, active: true, csat: 4.0 }
      ];
              ...
              <Card key={c.id} className={`bg-white border border-zinc-200/80 rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition duration-300 flex flex-col justify-between ${!c.active ? 'opacity-65 border-dashed bg-zinc-50/50' : ''}`}>
                ...
                <div className="p-5 space-y-3.5 text-xs text-zinc-700 flex-1">
                  ...
                  <div className="flex items-start gap-2">
                    <Award size={13} className="text-zinc-400 shrink-0 mt-0.5" />
