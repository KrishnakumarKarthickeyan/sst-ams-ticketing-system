    ...
    <div className="max-w-screen-xl mx-auto p-6 md:p-8 space-y-6">
      ...
      <Dialog open={createConsultantOpen} onOpenChange={setCreateConsultantOpen}>
        <DialogContent className="max-w-lg bg-surface p-6 rounded-lg text-ink border border-line shadow-xl overflow-y-auto max-h-[90vh]">
          <DialogHeader>
            <DialogTitle className="text-lg font-semibold tracking-tight text-ink">New Consultant</DialogTitle>
          ...
          <form onSubmit={handleCreateConsultantSubmit} className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className={`h-9 text-xs focus-visible:ring-1 focus-visible:ring-brand/30 ${consEmailError ? 'border-red-500' : ''}`}
                />
                {consEmailError && (
                  <p className="text-[11px] text-critical font-bold flex items-center gap-1">
            ...
            {/* Specialization */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-ink">Specialization / Delivery Focus</label>
              <Input
            ...
            <div className="space-y-3 border-t border-line pt-3">
              <label className="text-sm font-medium text-ink block">Access Credentials</label>
              <div className="flex gap-4">
                <label className="flex items-center gap-1.5 cursor-pointer text-xs font-semibold text-ink-secondary">
                  <input
                    type="radio"
                    name="consPasswordMode"
                    checked={consPasswordMode === 'auto'}
                    onChange={() => setConsPasswordMode('auto')}
                    className="w-4 h-4 text-ink focus:ring-brand/30 cursor-pointer"
                  />
              ...
              {consPasswordMode === 'manual' && (
                <div className="space-y-2 bg-surface-muted border border-line rounded p-3">
                  <div className="relative">
                    <Input
                      ...
                      className="h-9 text-xs focus-visible:ring-1 focus-visible:ring-brand/30 pr-10"
                    />
                    <button
                      type="button"
            ...
            <div className="flex items-center justify-between border-t border-line pt-3 pb-1">
              <div className="space-y-0.5">
                ...
                <span className="text-[11px] text-ink-muted block">Allows this consultant to authenticate</span>
              </div>
      ...
      <Dialog open={createClientOpen} onOpenChange={setCreateClientOpen}>
        <DialogContent className="max-w-lg bg-surface p-6 rounded-lg text-ink border border-line shadow-xl overflow-y-auto max-h-[90vh]">
          <DialogHeader>
            <DialogTitle className="text-lg font-semibold tracking-tight text-ink">New Client</DialogTitle>
            <DialogDescription className="text-xs text-ink-secondary mt-1">
          ...
          <form onSubmit={handleCreateClientSubmit} className="space-y-5 pt-2">
            ...
            <div className="space-y-4">
              <h3 className="text-xs font-bold uppercase tracking-wider text-ink-muted border-b border-line pb-1.5">
                SECTION A — Client Details
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className={`h-9 text-xs focus-visible:ring-1 focus-visible:ring-brand/30 ${clientEmailError ? 'border-red-500' : ''}`}
                  />
                  {clientEmailError && (
                    <p className="text-[11px] text-critical font-bold flex items-center gap-1">
              ...
              <div className="space-y-3 bg-surface-muted/60 border border-line rounded-lg p-3">
                <div className="flex justify-between items-center">
                  <label className="text-xs font-bold uppercase tracking-wider text-ink-secondary">Organization *</label>
                  <button
                    type="button"
                    onClick={() => setClientOrgMode(prev => prev === 'existing' ? 'new' : 'existing')}
                    className="text-[11px] font-bold text-ink hover:underline cursor-pointer"
                  >
                  ...
                  <div className="space-y-3 pt-1">
                    <div className="grid grid-cols-3 gap-2">
                      <div className="col-span-2 space-y-1">
                        <label className="text-[11px] font-medium text-ink-secondary">Company Name *</label>
                        <Input
                          required
                      ...
                      <div className="space-y-1">
                        <label className="text-[11px] font-medium text-ink-secondary">Short Code *</label>
                        <Input
                          required
                          maxLength={4}
                          placeholder="APX"
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-medium text-ink-secondary">Domain (optional)</label>
                      <Input
              ...
              <div className="flex items-center justify-between border-t border-line pt-3 pb-1">
                <div className="space-y-0.5">
                  <label className="text-sm font-medium text-ink block">Login Permissions</label>
                  <span className="text-[11px] text-ink-muted block">Allows this client to authenticate</span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
            ...
            <div className="space-y-4 border-t border-line pt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-ink">Project / SLA Type *</label>
                  <select
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-ink">Contract Status *</label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-ink-secondary flex items-center gap-1">
                    <Calendar className="h-3 w-3 text-ink-muted" /> Start Date *
                  </label>
                  <Input
                    required
                    type="date"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-ink-secondary flex items-center gap-1">
                    <Calendar className="h-3 w-3 text-ink-muted" /> End Date *
                  </label>
                  <Input
                    required
                    type="date"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-ink-secondary flex items-center gap-1">
                    <Clock className="h-3 w-3 text-ink-muted" /> Monthly Allocated Hours *
                  </label>
                  <Input
                    required
                    type="number"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-ink-secondary flex items-center gap-1">
                    <Clock className="h-3 w-3 text-ink-muted" /> Total Annual Hours *
                  </label>
                  <Input
                    required
                    type="number"
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-2">
                    <div className="bg-surface-muted border border-line rounded px-3 py-2 text-[11px] text-ink-secondary flex justify-between">
                    ...
                    {showWarning && (
                      <div className="bg-amber-50 border border-amber-200 rounded px-3 py-2 text-[11px] text-amber-800 flex items-start gap-2">
