...
export default function ConsultantTicketDetailLoading() {
  return (
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
            <div className="space-y-3 flex-1 w-full">
              ...
              <div className="flex gap-4">
                <Skeleton className="h-4 w-32 bg-surface-subtle" />
                <Skeleton className="h-4 w-24 bg-surface-subtle" />
                <Skeleton className="h-4 w-28 bg-surface-subtle" />
              </div>
            </div>
            {/* Action buttons */}
          ...
          <div className="pt-4 border-t border-line flex justify-between items-center relative">
            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                ...
                <Skeleton className="h-3 w-14 bg-surface-subtle rounded" />
              </div>
            ))}
          </div>
        </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex gap-2 items-center">
                      ...
                      <div>
                        ...
                        <Skeleton className="h-3 w-16 bg-surface-subtle rounded mt-1" />
                      </div>
                    </div>
                    <Skeleton className="h-3 w-20 bg-surface-subtle rounded" />
                  </div>
              ...
              <div className="space-y-3">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="flex justify-between items-center py-2 border-b border-zinc-50">
                    <Skeleton className="h-3.5 w-20 bg-surface-subtle" />
