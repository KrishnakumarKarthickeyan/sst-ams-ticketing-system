    ...
    <div className="flex min-h-[50vh] items-center justify-center p-4">
      <Card className="w-full max-w-md border-red-100 bg-surface shadow-xl shadow-red-50/50 rounded-2xl overflow-hidden relative">
        ...
        <CardHeader className="text-center pt-8 pb-4">
          <div className="mx-auto w-12 h-12 bg-critical-soft text-critical rounded-full flex items-center justify-center mb-4">
        ...
        <CardContent className="bg-surface-muted border-y border-line py-4 px-6 text-center space-y-2">
          ...
          <p className="text-sm text-critical bg-critical-soft/50 border border-red-100/60 p-3 rounded-lg overflow-x-auto text-left whitespace-pre-wrap leading-relaxed max-h-32">
